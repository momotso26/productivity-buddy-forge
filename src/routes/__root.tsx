  ...
  head: () => ({
    meta: [
      ...
      { title: "AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Draft emails, summarise meetings, plan tasks and research topics in one AI workspace.",
      },
      { property: "og:title", content: "AI Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "One calm workspace for drafting, summarising, planning and research.",
      },
        ...
        <div className="flex min-h-screen w-full bg-background">
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            <header className="sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border bg-background/85 px-4 backdrop-blur-md">
              ...
              <span className="ml-auto rounded-full border border-border bg-surface px-2.5 py-1 text-xs text-muted-foreground">
